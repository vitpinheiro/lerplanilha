...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        my_image = customtkinter.CTkImage(light_image=Image.open(r"C:\Users\pedronobrega\Desktop\Ler_Planilhas_Novo\LOGO.png"), dark_image=Image.open(r"C:\Users\pedronobrega\Desktop\Ler_Planilhas_Novo\LOGO.png"), size=(85, 85))
        ...
        botao_logo.place(x=30, y=20)

        # Cria a label referente ao título da página
        label_principal = customtkinter.CTkLabel(self, text = "LEITOR DE PLANILHAS", fg_color="transparent", height=130, font = ("Arial Rounded MT Bold", 30, "bold"))
